...
you need to include this line within the button's click
//
//
//
listener.
//
successfully initialized before calling this method.
//
  Otherwise, the method won't function as intended.
    if (s.equals("passport")){
        ...
        val resultListener = object : ResultListener {
            override fun onResultData(jsonObject: JSONObject?,
scannedDocType:           String?) {
